// ✅ Update ProfileSidebar.tsx with Report Modal integration
"use client";
...
export const ProfileSidebar: React.FC<ProfileSidebarProps> = ({
  ...
  // ✅ Handle report user function
  const handleReportUser = () => {
    if (!otherParticipant || !conversation) {
      console.error('[ProfileSidebar] Missing participant or conversation data');
      return;
    }

    console.log("[ProfileSidebar] Opening report modal for user:", {
    ...
    if (!otherParticipant._id || !otherParticipant.fullName) {
      console.error('[ProfileSidebar] Invalid user data for reporting:', otherParticipant);
    ...
    setReportModal({
      isOpen: true,
      reporteeId: otherParticipant._id,
      reporteeName: otherParticipant.fullName,
      chatReferenceId: conversation._id,
    });
  };
            ...
            <div className="text-center">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                ...
                <p className="text-xs text-gray-500 text-center mt-2">
                  Reporting helps us maintain a safe community. Please provide as
