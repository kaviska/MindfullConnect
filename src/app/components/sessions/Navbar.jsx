  ...
  return (
    <div className="bg-white shadow-[0_2px_20px_rgba(0,0,0,0.05)] sticky top-0 z-[100]">
      <nav className="max-w-[1200px] mx-auto px-5 py-0 flex items-center justify-between h-[70px]">
        <Link href="/" className="text-2xl font-bold text-[#0369a1] no-underline">
          Mindfull Connect
        </Link>
        <ul
          className={`flex list-none gap-7 items-center ${
            isMobileMenuOpen ? 'flex-col absolute top-[70px] left-0 w-full bg-white p-5 shadow-md' : 'hidden md:flex'
          }`}
        >
          <li>
            <Link
              href="/"
              className="no-underline text-[#64748b] font-medium py-2 px-4 rounded-full hover:text-[#0369a1] hover:bg-[#f0f9ff] transition-all"
            >
              Home
            </Link>
          </li>
          <li>
            <Link
              href="/book-session"
              className="no-underline text-[#0369a1] font-medium py-2 px-4 rounded-full bg-[#e0f2fe]"
            >
              Book Session
            </Link>
          </li>
          <li>
            <button
              ...
              aria-label="Open My Bookings modal"
            >
              My Bookings
            </button>
          </li>
        ...
        <div className="flex items-center gap-5">
          <svg
            className="w-6 h-6 text-[#64748b] cursor-pointer hover:text-[#0369a1] transition-colors"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
            <path
              ...
              strokeWidth="2"
              d="M15 17h5l-5-5c.55 0 1-.45 1-1V6a4 4 0 00-8 0v5c0 .55.45 1 1 1l-5 5h5m2 0a2 2 0 11-4 0"
            />
          </svg>
          <img
