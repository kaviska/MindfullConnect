...
const SearchBar = () => {
  return (
    <div className="flex gap-2.5 items-center px-5 py-0 bg-slate-100 h-[50px] rounded-[40px] max-md:px-4 max-md:py-0">
      <div>
        <svg
          width="20"
          height="20"
